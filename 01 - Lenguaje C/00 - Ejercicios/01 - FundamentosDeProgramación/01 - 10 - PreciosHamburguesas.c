/*
** #########################################################################################
**  Archivo         :   01 - 08 - PreciosHamburguesas.c
**  Proyecto        :   Lenaguajes
...
**                      Jelp 200
**  Descripcion     :
**                      El usuario dara el precio que desea pagar por una hamburguesa y el
**                      sistema le indicara que hamburguesa le conviene más.
**
**                      Clasica -------- $50
**                      Burroburguer --- $70
**                      Especial ------- $150
